...
class RequestTest extends WordSpec with Matchers
{
   "A RTU request" when {
      "requesting for reading of coils (function 1)" should {
         "be correctly converted to Modbus RTU Frame" in {
            new ReadCoilsRequest(4, 10, 13).createRTUFrame() shouldBe
               Array[Byte](0x04, 0x01, 0x00, 0x0a, 0x00, 0x0d, 0xdd.toByte, 0x98.toByte)
         }
      }

      "requesting for reading of discrete inputs (function 2)" should {
         "be correctly converted to Modbus RTU Frame" in {
      ...
      "requesting for reading of Holding registers (function 3)" should {
         "be correctly converted to Modbus RTU Frame" in {
      ...
      "requesting for reading of Input Registers (function 4)" should {
         "be correctly converted to Modbus RTU Frame" in {
